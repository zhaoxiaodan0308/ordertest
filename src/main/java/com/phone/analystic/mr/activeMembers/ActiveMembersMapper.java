 ...
 * 用户模块下的新增用户
 */
public class ActiveMembersMapper extends Mapper<LongWritable, Text, StatsUserDimension, TimeOutputValue> {
    private static final Logger logger = Logger.getLogger(ActiveMembersMapper.class);
    private StatsUserDimension k = new StatsUserDimension();
    private TimeOutputValue v = new TimeOutputValue();
    private KpiDimension activeUserKpi = new KpiDimension(KpiType.ACTIVE_MEMBERS.kpiName);
    private KpiDimension browseractiveUserKpi = new KpiDimension(KpiType.BROWSER_ACTIVE_MEMBERS.kpiName);
