 ...
 * 作者姓名 修改时间 版本号 描述
 */
public class ActiveMembersReducer extends Reducer<StatsUserDimension, TimeOutputValue,
        StatsUserDimension, OutputWritable> {
    private static final Logger logger = Logger.getLogger(ActiveMembersReducer.class);
