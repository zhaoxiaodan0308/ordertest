 ...
 * 作者姓名 修改时间 版本号 描述
 */
public class BrowserActiveUserOutputWriter implements IOutputWritter {
    private static  Logger logger= Logger.getLogger(BrowserActiveUserOutputWriter.class);
    ...
    public void ouput(Configuration conf, StatsBaseDimension key, StatsOutpuValue value, PreparedStatement ps, IDimension iDimension) {
        ...
        try {
            ...
            logger.error("浏览器新用户中活跃用户指标ps赋值错误",e);
        }
